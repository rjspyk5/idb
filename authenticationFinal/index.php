...
$error = isset($_POST['username'] ) ? "Invalid username or password. Please try again." : "";
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body class="bg-slate-800 h-screen">
    ...
    <div class="form-container w-1/3 mx-auto  p-5  text-center rounded-lg shadow-md shadow-white text-white">
        ...
        <form class="space-y-3 space-x-3 *:rounded-lg" method="post" action="">
            ...
            <input class="p-1" type="password" id="password" name="password" required><br>
            <input class="btn btn-sm bg-green-500 text-white" type="submit" value="Login">
        </form>
    <div>    
    </div>
    </div>
